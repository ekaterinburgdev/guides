    ...
    return (
        <section style={{ backgroundColor: bgColor }} className={styles.CommonLinks__container}>
            <Link className={styles.CommonLinks__tooltiptarget} href="/">
                ...
                />
                <span className={styles.CommonLinks__tooltiptext}>Транспорт Екатеринбурга</span>
            </Link>
            <Link className={styles.CommonLinks__tooltiptarget} href="/">
                <Image
                    src="/ecosystem.svg"
                    ...
                    className={styles.CommonLinks__icon}
                />
                <span className={styles.CommonLinks__tooltiptext}>Экосистема Екатеринбурга</span>
            </Link>
